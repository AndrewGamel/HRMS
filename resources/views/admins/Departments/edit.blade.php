    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('shift_types.update', $data->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" id="from_time" class="form-control"
                                    value="{{ old('from_time',$data['from_time']) }}" name="from_time">
                                @error('from_time')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="time" id="to_time" class="form-control"
                                       value="{{ old('to_time',$data['to_time']) }}" name="to_time">
                                @error('to_time')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="total_hours" class="form-control" placeholder="أدخل عدد الساعات "
                                    value="{{ old('total_hours',$data['total_hours']) }}" name="total_hours">
                                @error('total_hours')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="active" id="active" class="form-control ">
                                    <option @if (old('active',$data['active']) == 0 and old('active') != '') selected @endif value="0">غير مفعل</option>
