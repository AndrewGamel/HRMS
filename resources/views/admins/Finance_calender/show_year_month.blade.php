   @if (@isset($finance_cln_period) and !@empty($finance_cln_period))

       <table id="example2" class="table table-bordered table-hover ">
           <thead class="thead-light">
               <th> أسم الشهر عربي</th>
               <th> أسم الشهر إنجلزي</th>
               <th>تاريخ البداية</th>
               <th>تاريخ النهاية</th>
               <th> عدد الايام</th>
               <th>حالة الشهر </th>
           ...
           <tbody>
               @foreach ($finance_cln_period as $info)
                   <tr>
                       ...
                       <td>
                           @if ($info->is_open == 1) مفتوح
                           @elseif ($info->is_open == 2) مؤرشف
                           @else مغلق
                           @endif
                       </td>
