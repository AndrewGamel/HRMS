...
<body class="hold-transition login-page"
    style="background-size:cover;background-image: url('{{ asset('assets/admin/dist/img/login.jpg') }}') ">
    <div class="login-box">
        <div class="login-logo">
            <a href="#"><b class="text-red text-bold ">HR</b>MS</a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg f-bold text-bold">تسجيل الدخول</p>
                ...
                <form action="{{ route('admin.login') }}" method="post">
                    ...
                    @error('username')
                        <div class="text-right  text-danger font-weight-lighter">
                            {{ $message }}
                        </div>
                    @enderror
